...
if __name__ == "__main__":
    ...
    svm_linear_model = svm_train(digit, intensity, "-s 0 -t 0 -q -c 1")
    #print svm_linear_model
    #svm_save_model("linearmodelq2c", svm_linear_model)
    #loaded_svm_model = svm_load_model("linearmodelq2c")
    svm_predict(digit, intensity, svm_linear_model)
    print "\nTesting Linear",
    svm_predict(test_digit, test_intensity, svm_linear_model)
